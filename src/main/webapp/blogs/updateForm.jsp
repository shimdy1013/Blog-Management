                    ...
                    <div class="col-md-10 col-lg-8 col-xl-7">
                        ...
                        <div class="my-5">
                            ...
                            <form id="contactForm" action="update.do" method="post">
                                ...
                                <div class="form-floating">
                                    <input class="form-control" name="title" value="${blog.title}" id="title" type="text" placeholder="Enter title..." data-sb-validations="required" />
                                    <label for="title">Title</label>
                                    <div class="invalid-feedback" data-sb-feedback="title:required">A phone number is required.</div>
                                </div>
                                <div class="form-floating">
                                    <textarea class="form-control" name="content" id="content" placeholder="Enter content here..." style="height: 12rem" data-sb-validations="required">${blog.content}</textarea>
